...
class MecanicoControlador {
    async crearMecanico(req, res) {
        try {
            const { nombre_mecanico, apellido_mecanico, telefono_mecanico, especialidad_mecanico, email_mecanico } = req.body;
            const nuevoMecanico = await mecanicoModel.crearMecanico({ nombre_mecanico, apellido_mecanico, telefono_mecanico, especialidad_mecanico, email_mecanico });
    ...
    async actualizarMecanico(req, res) {
        try {
            const { id_mecanico } = req.params;
            const { nombre_mecanico, apellido_mecanico, telefono_mecanico, especialidad_mecanico, email_mecanico } = req.body;
            const mecanicoActualizado = await mecanicoModel.actualizarMecanico({ id_mecanico, nombre_mecanico, apellido_mecanico, telefono_mecanico, especialidad_mecanico, email_mecanico });
